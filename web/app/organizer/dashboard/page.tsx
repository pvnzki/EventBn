...
const AdminDashboardPage = () => {
  ...
  useEffect(() => {
    if (user?.organization_id) {
      fetch(
        `http://localhost:3000/api/analytics/organizer/${user.organization_id}/dashboard/overview`
      )
        .then((res) => res.json())
        .then((response) => {
          if (response.success) {
  ...
  useEffect(() => {
    if (user?.organization_id) {
      fetch(
        `http://localhost:3000/api/analytics/organizer/${user.organization_id}/dashboard/revenue-trend`
      )
        .then((res) => res.json())
        .then((response) => {
          if (response.success) {
