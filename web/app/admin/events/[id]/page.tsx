              ...
              <Card>
                ...
                <CardContent>
                  {(() => {
                    ...
                    // Group seats by ticket type/category
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-4 text-xs">
                            <div className="flex items-center gap-1">
                              <div className="w-5 h-5 rounded border-2 bg-red-500 border-red-700"></div>
                                ...
                                <div className="flex gap-2 flex-wrap">
                                  {rowSeats.map((seat) => {
                                    ...
                                    return (
                                      <div
                                        key={seat.id}
                                        className="w-10 h-10 rounded-lg text-xs font-bold flex items-center justify-center border-2 shadow-md"
                                        style={{
