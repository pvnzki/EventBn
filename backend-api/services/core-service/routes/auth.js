...
router.put('/profile', authenticateToken, async (req, res) => {
  try {
    ...
    if (billing_country !== undefined) updateData.billing_country = billing_country || null;
    ...
    if (marketing_emails_enabled !== undefined) updateData.marketing_emails_enabled = marketing_emails_enabled;
    if (event_notifications_enabled !== undefined) updateData.event_notifications_enabled = event_notifications_enabled;
